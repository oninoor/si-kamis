    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">Laporan Kunjungan</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Tabel Laporan Kunjungan</li>
                            </ol>
                        </nav>
                    </div>
                    <br>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">List Laporan Kunjungan</h4>
                </div>
                <?php if (empty($tgl_awal) && empty($tgl_akhir)) { ?>
                    <form method="post" action="<?= base_url('Laporan/filter_laporan_kunjungan') ?>">
                        <div class="row ml-2">
                            ...
                            <div class="form-group col-md-4" style="margin-top: 35px;">
                                ...
                                <?php } else if ($this->session->userdata('role') == 1) { ?>
                                    <a href="<?= base_url('Laporan/laporan_kunjungan_admin') ?>" class="btn btn-primary"><i class="fa fa-refresh"></i> Refresh</a>
                                <?php } else if ($this->session->userdata('role') == 2) { ?>
                                    <a href="<?= base_url('Laporan/laporan_kunjungan_loket') ?>" class="btn btn-primary"><i class="fa fa-refresh"></i> Refresh</a>
                                <?php } ?>
                            </div>
                        </div>
                    </form>
