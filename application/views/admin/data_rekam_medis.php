            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 mt-3">
                        <a href="<?= base_url('Admin/riwayat_rekam_medis') ?>" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                    </div>
                </div>
            </div>
            <?php if (empty($data_rekmed)) { ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fa fa-info-circle"></i> No Rekam Medis yang anda cari belum terdaftar / belum memiliki riwayat rekam medis
                </div>
            <?php } else { ?>
                <?php $no = 1;
