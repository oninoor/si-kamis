...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">Data Riwayat Kunjungan</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Tabel List Riwayat Kunjungan</li>
                            </ol>
                        </nav>
                    </div>
                    <br>
            ...
            <!-- Simple Data Riwayattable start -->
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">List Data Riwayat Kunjungan</h4>
                </div>
                <div class="pb-20">
                        ...
                        <tbody>
                            ...
                            foreach ($riwayat as $view) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Admin/detail_riwayat_kunjungan/' . $view->kd_kunjungan) ?>" title="detail kunjungan" class="badge bg-success" style="color: white;"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
