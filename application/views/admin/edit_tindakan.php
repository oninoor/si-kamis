    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Form Edit Tindakan</li>
                            </ol>
                        </nav>
                    </div>
                    <br>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Form Edit Tindakan</h4>
                        <p class="mb-30">tanda <span style="color: red;">*</span> wajib di isi</p>
                    </div>
                </div>
                <form method="POST" action="<?= base_url('Admin/update_tindakan') ?>">
                    <div class="form-group">
                        <label>Tindakan <span style="color: red;">*</span></label>
                        <input type="hidden" name="id" value="<?= $edit->id ?>"> 
                        <input class="form-control" type="text" value="<?= $edit->tindakan ?>" name="tindakan" placeholder="Tindakan">
                        <?= form_error('tindakan', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label>Tindakan ICD 9CM <span style="color: red;">*</span></label>
                        <input class="form-control" type="text" value="<?= $edit->tindakan_icd_9cm ?>" name="tindakan_icd_9cm" placeholder="Tindakan ICD 9CM">
                        <?= form_error('tindakan_icd_9cm', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label>Kode Tindakan ICD 9CM</label>
                        <input class="form-control" type="text" value="<?= $edit->kode_tindakan_icd_9cm ?>" name="kode_tindakan_icd_9cm" placeholder="Kode Tindakan ICD 9CM">
