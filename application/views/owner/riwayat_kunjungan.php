                        ...
                        <tbody>
                            ...
                            foreach ($riwayat as $view) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Owner/detail_riwayat_kunjungan/' . $view->kd_kunjungan) ?>" title="detail kunjungan" class="badge bg-success" style="color: white;"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
