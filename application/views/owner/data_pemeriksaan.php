                        ...
                        <tbody>
                            ...
                            foreach ($pemeriksaan as $view) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Owner/detail_pemeriksaan/' . $view->kd_kunjungan) ?>" title="Detail Kunjungan" class="badge bg-success" style="color: white;"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
