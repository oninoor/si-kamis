    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">List Data Pemeriksaan Anda</h4>
                </div>
                <div class="pb-20">
                        ...
                        <tbody>
                            ...
                            foreach ($perawatan as $view) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Pasien/detail_pemeriksaan/' . $view->kd_kunjungan) ?>" title="Detail Perawatan" class="badge bg-success" style="color: white;"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
